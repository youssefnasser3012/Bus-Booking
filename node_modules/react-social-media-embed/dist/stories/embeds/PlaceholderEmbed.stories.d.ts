...
declare const StoryComponent: ({ url, linkText, imageUrl, spinner, spinnerDisabled, ...divProps }: import("../../components/placeholder/PlaceholderEmbed").PlaceholderEmbedProps) => React.JSX.Element;
